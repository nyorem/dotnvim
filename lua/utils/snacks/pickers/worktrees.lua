---copied from https://github.com/okuuva/nvim/blob/main/lua/user/plugins/utils/snacks/pickers/worktrees.lua
...
return {
  ...
  keys = {
    ...
    { "<leader>ww", function() Snacks.picker.worktrees() end, desc = "List Worktrees" },
    ---@diagnostic disable-next-line: undefined-field
    { "<leader>wa", function() Snacks.picker.worktrees_new() end, desc = "New Worktree" },
  },
  specs = {
    "snacks.nvim",
